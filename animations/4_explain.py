...
class NeuralNetwork(Scene):
    arguments = {  # ideal arguments for a network_size of 2
        "network_size": 2,
        ...
        "neuron_width": 3,
        "neuron_fill_color": "#000B22",
        "neuron_fill_opacity": 1,
        "neuron_buff": MED_SMALL_BUFF,
        "edge_color": YELLOW_B,
        "edge_width": 2.5,
        "edge_opacity": 0.75,
        "layer_label_color": YELLOW_B,
        "layer_label_size": 1,
        "neuron_label_color": YELLOW_B
    }
    ...
    def get_edge(self, neuron1, neuron2):
        return Line(
            neuron1.get_center(),
            neuron2.get_center(),
            buff=2.25*NeuralNetwork.arguments["neuron_radius"],
    ...
    def label_neurons(self):
        ...
        self.play(Write(hidden_labels1))
        ...
        self.play(Write(hidden_labels2))
    ...
    def wiggle_animation(self):
        ...
        self.play(LaggedStartMap(
            ApplyFunction, edges,
            lambda mob: (lambda m: m.rotate(np.pi/12).set_stroke(MAROON_E, 2.5), mob),
            rate_func=wiggle),
            run_time=3)
        self.play(LaggedStartMap(
            ApplyFunction, edges,
