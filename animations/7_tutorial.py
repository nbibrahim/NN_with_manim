...
class NeuralNetwork(Scene):
    ...
    def pulse_animation(self):
        ...
        self.play(LaggedStartMap(Circumscribe, edge_group,
            run_time=1.5))
        self.wait()
    ...
    def display_code(self):
        ...
        inputs = Code(r"./code_references/7_code_reference.py", style=Code.styles_list[7]).code.chars[0]
        inputs.scale(2)
        inputs.shift(UP)
        weights = Code(r"./code_references/7_code_reference.py", style=Code.styles_list[7]).code.chars[1]
        weights.scale(2)
        weights.next_to(inputs, DOWN)
        bias = Code(r"./code_references/7_code_reference.py", style=Code.styles_list[7]).code.chars[2]
        bias.scale(2)
        bias.next_to(weights, DOWN)
        output = Code(r"./code_references/7_code_reference.py", style=Code.styles_list[7]).code.chars[4:11]
        output.scale(2)
        output.next_to(bias, DOWN)

        self.play(Write(inputs), run_time=4)
        self.pulse_animation()
        self.wait(7)
        self.play(Write(weights), run_time=4)
        self.pulse_animation()
        self.play(Write(bias), run_time=2)
        self.pulse_animation()
        self.wait()
        self.play(Write(output), run_time=8)
        self.pulse_animation()

        group = VGroup(inputs, weights, bias, output)
        self.play(FadeOut(group))
        complete_code = Code(r"./code_references/7_code_reference.py", style=Code.styles_list[7])
        complete_code.scale(1.5)
        self.play(Write(complete_code), run_time=3)
        self.pulse_animation()
        self.wait(10)
